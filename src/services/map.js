...
export default {
    getUserLocation: getLocationOfUser,
...
function chooseNearestLocation(locations, currentCoords) {
    let beginCoord = {},
        nearest = _.clone(locations).reduce((prev, current) => {
            current.distance = calculateDistance(current.lat, current.lng, currentCoords.lat, currentCoords.lng);
